package com.sigma.socialgame.view.gui.components
{
	...
	public class ManureAlert extends AlertWindow
	{
		public function ManureAlert()
		{
			super();
		...
		protected override function onOkButtonClick(e:MouseEvent):void
		{
			...
			var stringCase : StringCase = StringManager.instance.getCase(StringTypes.ManurePublish);
