...
//					trace("Trying to create new client connection ", this._connectionName);
					Logger.message("Trying to create new client connection " + this._connectionName, "ForticomAPI", LogLevel.Error, LogModule.Model);
...
//				trace("Client connection already exists!");
				Logger.message("Client connection already exists!", "ForticomAPI", LogLevel.Error, LogModule.Model);
...
//					trace("Telling proxy to make reconnect...");
					Logger.message("Telling proxy to make reconnect...", "ForticomAPI", LogLevel.Error, LogModule.Model);
...
//				trace("Proxy not responding!");
				Logger.message("Proxy not responding!", "ForticomAPI", LogLevel.Error, LogModule.Model);
			}
		}
...
//				trace("Concurrent client not responding!");
				Logger.message("Concurrent client not responding!", "ForticomAPI", LogLevel.Error, LogModule.Model);
			}
		}
...
//			if (DEBUG)	trace('Client connection established');
			if (DEBUG)	Logger.message('Client connection established', "ForticomAPI", LogLevel.Error, LogModule.Model);
...
//				trace ("Sending " + method + " (" + rest + ")");
				Logger.message("Sending " + method + " (" + rest + ")", "ForticomAPI", LogLevel.Error, LogModule.Model);
			if (this._connected)
			{
				if (rest.length) {
...
//			if (DEBUG)	trace('CLI: Method '+method+", arguments "+rest);
			if (DEBUG)	Logger.message('CLI: Method '+method+", arguments "+rest, "ForticomAPI", LogLevel.Error, LogModule.Model);
